...
import static nl.haltedata.gtfs.config.batch.BatchImportConfigForGtfsQuays.JOB_NAME;
...
@RequestMapping("/importGtfs")
public class ImportGtfsController {
    private static String file = "/home/gertjan/projects/NLGeo/Haltedata/stops.txt";
