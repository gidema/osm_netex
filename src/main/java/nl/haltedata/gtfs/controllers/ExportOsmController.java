...
@RestController
    @RequestMapping("/exportOsm")
    @RequiredArgsConstructor
    public class ExportOsmController {
        private static String file="/home/gertjan/Downloads/gtfs_quays.osm";
...
//        private final GtfsQuayRepository quayRepository;
        ...
        public ResponseEntity<String> handle() throws Exception {
            ...
            JobParameters params = new JobParametersBuilder()
                ...
                .toJobParameters();
            var job = jobRegistry.getJob("exportGtfs2OsmJob");
