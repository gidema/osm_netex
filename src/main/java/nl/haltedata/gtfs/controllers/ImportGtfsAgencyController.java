...
import static nl.haltedata.gtfs.config.batch.BatchImportConfigForGtfsAgencies.JOB_NAME;
...
// TODO this code is almost a copy of importGtfsQuay. Move common code to an other class
@RestController
@RequiredArgsConstructor
@RequestMapping("/importGtfsAgency")
public class ImportGtfsAgencyController {
    private static String file = "/home/gertjan/projects/NLGeo/Haltedata/agency.txt";
