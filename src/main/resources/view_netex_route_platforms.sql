...
SELECT DISTINCT line.name, route.line_ref, por.route_id, por.sequence, psa.quay_code, cq.stop_side_code, cq.stop_place_name AS name, cq.town, cq.quay_status 
...
--    AND cq.town LIKE '%osch'	
	AND route.line_ref = 'ARR:Line:51102#FY:P376'
